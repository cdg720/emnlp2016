...
Due to stochasticity, runs of training may produce models with slightly different results from what we report in the paper. We have retrained a few models after the publication of our paper and we report F1s and numbers of epochs of several training runs:
